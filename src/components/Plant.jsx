      ...
      <Card sx={{ minWidth: 275 }}>
        <CardContent>
          <center><h1>Plant Details</h1>
            <form>
              Plant Code : <input type="text" name="plantid" id='p1' value={inputs.plantid} onChange={inputHandler} />
              <br /><br />
              Plant Name : <input type="text" name="plantname" id="p2" value={inputs.plantname} onChange={inputHandler} />
              <br /><br />
              Plant Type :
              <select name="planttype" value={inputs.planttype} onChange={inputHandler}  >
                {
              ...
              <br /><br />
              Color : <input type="text" name="color" id="p4" value={inputs.color} onChange={inputHandler} />
              <br /><br />
